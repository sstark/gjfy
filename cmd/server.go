...
var serverCmd = &cobra.Command{
	Use:   "server",
	Short: "control the main gjfy service",
	Long: `The server subcommand starts the gjfy web service, which will be exposed
to users to retrieve secrets.
This contains the functionality of previous gjfy releases.`,
